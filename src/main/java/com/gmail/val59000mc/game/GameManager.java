...
public class GameManager{
	...
	private void registerCommands(){
		...
		registerCommand("tl", new TeamLocationCommandExecutor(playerManager));
		registerCommand("nv", new NightVisionCommandExecutor(playerManager));
		registerCommand("clearitem", new ClearItemCommandExecutor(playerManager));
		registerCommand("kt", new KillTopCommandExecutor(playerManager));
