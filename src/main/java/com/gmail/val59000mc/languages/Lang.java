...
public class Lang{
	...
	public static String SCENARIO_FALLOUT_DAMAGE;
	...
	public static String SCENARIO_COBWEBLESS_ENABLED;
	...
	private void loadLangConfig() {
		...
		SCENARIO_FALLOUT_DAMAGE = getString(lang, "scenarios.fallout_fo.damage", "&4[Fallout] &cYou're taking damage from being above y=60");
		...
		SCENARIO_COBWEBLESS_ENABLED = getString(lang, "scenarios.cowebless.error", "CobWebless is enabled");
