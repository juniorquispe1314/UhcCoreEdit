...
public class Scenario {
	...
	public static final Scenario TEAM_INVENTORY = new Scenario("team_inventory", Material.ENDER_CHEST, TeamInventoryListener.class);
	...
	public static final Scenario HB_PLUS = new Scenario("plus", UniversalMaterial.NETHERITE_PICKAXE, HBPlusListener.class);
	...
	public static final Scenario NERF_STRENGTH = new Scenario("nerf_strength", Material.BLAZE_POWDER, NerfStrengthListener.class);
	public static final Scenario FALLOUT = new Scenario("fallout_fo", UniversalMaterial.DIAMOND_SHOVEL, FalloutListener.class);
	public static final Scenario LOST_SOULS = new Scenario("lost_souls", UniversalMaterial.SOUL_CAMPFIRE, LostSoulsListener.class);
	public static final Scenario COBWEBLESS = new Scenario("cowebless", Material.COBWEB, CobWebLessListener.class);
	public static final Scenario COLDWEAPONS = new Scenario("coldweapons", Material.PACKED_ICE, ColdWeaponsListener.class);
	public static final Scenario GAPPLEROULETTE = new Scenario("gappleroulette", Material.SPLASH_POTION, GappleRouletteListener.class);
	public static final Scenario WEBCAGE = new Scenario("webcage", Material.QUARTZ_BLOCK, WebCageListener.class);
	public static final Scenario ENCHANTMENTDEATH = new Scenario("enchantment_death", Material.ENCHANTED_BOOK, EnchantmentDeathListener.class);
	public static final Scenario ANVIL_LESS = new Scenario("anvil_less", Material.DAMAGED_ANVIL, AnvilLessListener.class);
	public static final Scenario BAREBONES = new Scenario("bare_bones", Material.IRON_CHESTPLATE, BareBonesListener.class);
	public static final Scenario UPGRADES = new Scenario("upgrades", Material.DIAMOND_CHESTPLATE, UpgradesListener.class);
	public static final Scenario LUCKY_ORES = new Scenario("lucky_ores", Material.EMERALD_BLOCK, LuckyOresListener.class);
	public static final Scenario FAST_GET_AWAY = new Scenario("fast_get_away", Material.DIAMOND_HORSE_ARMOR, FastGetAwayListener.class);
